...
import { editCalendarToday, editCalendarYesterday, addNewDayCustomItems } from '../store/itemSlice'
...
listenerMiddleware.startListening({
    predicate: (_action, currentState, previousState) => {
        ...
        return state.item.counter !== prevState.item.counter || state.item.lastSavedDate !== prevState.item.lastSavedDate
    },
